...
def get_recommendation(title):
    ...
    for i, j in enumerate(result.poster_path):
        ...
        recommended_movie_Rate.append(result.iloc[i].vote_average)
    return poster,Rate,overview,recommended_movie_names, recommended_movie_posters, recommended_movie_overview, recommended_movie_Rate
...
if st.button('Show Recommendation'):
    poster,Rate,overview,recommended_movie_names,recommended_movie_posters,recommended_movie_overview,recommended_movie_Rate = get_recommendation(selected_movie)
